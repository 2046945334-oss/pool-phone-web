...
- 情侣空间 (couple_room/couple_pocket/couple_lamp)
- 处理投递箱 (read_pocket)
...
function getTools() {
  return [
    ...
    { type:'function', function:{ name:'couple_pocket', description:'往口袋放纸条', parameters:{type:'object',properties:{content:{type:'string'}},required:['content']} }},
    ...
    { type:'function', function:{ name:'read_pocket', description:'读投递箱', parameters:{type:'object',properties:{}} }},
